...
def generate_launch_description():
    ...
    args = [
        ...
        DeclareLaunchArgument('enable_colored_point_cloud', default_value='true'),  # ← need color PC?
        ...
        DeclareLaunchArgument('depth_height', default_value='400'),   # native depth
        DeclareLaunchArgument('depth_fps',    default_value='30'),
        DeclareLaunchArgument('depth_align_to', default_value='color'),  # ★ align depth -> color
